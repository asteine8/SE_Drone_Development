...
double RaycastDistance = 500; // Camera only raycasts 800 meters for preformance reasons

double clearanceMultiplier = 1.5; // Scales up clearance from obstacles

double AtLocationRange = 18; // Drone is at a location if it is this range away from the posistion (meters)
